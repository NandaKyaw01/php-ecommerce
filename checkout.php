                        ...
                        <?php if ($checkout_access == 0): ?>
                            <div class="col-md-12">
                                <div style="color:red;font-size:22px;margin-bottom:50px;">
                                    သင်၏အော်ဒါကို ငွေရှင်းရန်အတွက် သင့်ဒက်ရှ်ဘုတ်မှ ငွေတောင်းခံလွှာနှင့် ပို့ဆောင်ရေးဆိုင်ရာ အချက်အလက်အားလုံးကို ဖြည့်စွက်ရန် လိုအပ်ပါသည်။ ကျေးဇူးပြု၍ ဤ<a href="customer-billing-shipping-update.php" style="color:black;text-decoration:underline;">လင့်ခ်</a>သို့ သွား၍ အချက်အလက်များကို ဖြည့်စွက်ပါ။.
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <select name="payment_method" class="form-control select2" id="advFieldsStatus">
                                            ...
                                            <option value="KPay"><?php echo LANG_VALUE_36; ?></option>
                                            <option value="Bank Deposit"><?php echo LANG_VALUE_38; ?></option>
                                        </select>
                                    </div>
                                    <form action="payment/kpay/init.php" method="post" id="kpay_form">
