                            ...
                            ?>
                                <tr class="<?php if ($row['payment_status'] == 'Pending') {
                                    ...
                                    <td style="min-width: 120px;">
                                        <?php
                                        $statement99 = $pdo->prepare("SELECT * FROM tbl_customer WHERE cust_id=?");
                                        $statement99->execute(array($row['customer_id']));
                                        $result99 = $statement99->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($result99 as $row99) { ?>
                                            <b>Name: </b><?php echo $row99['cust_s_name']; ?><br>
                                            <b>Phone: </b><?php echo $row99['cust_s_phone']; ?><br>
                                            <?php
                                            $statement100 = $pdo->prepare("SELECT * FROM tbl_country WHERE country_id=?");
                                            $statement100->execute(array($row99['cust_s_country']));
                                            $result100 = $statement100->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($result100 as $row100) { ?>
                                                <b>State: </b><?php echo $row100['country_name']; ?><br>
                                            <?php } ?>
                                            <b>City: </b><?php echo $row99['cust_s_city']; ?><br>
                                            <b>Address: </b><?php echo $row99['cust_s_address']; ?><br>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <?php
                                    ...
                                    <td>
                                        <?php if ($row['payment_method'] == 'KPay'): ?>
                                            ...
                                            <b>Transaction Information:</b> <?php echo $row['bank_transaction_info']; ?><br>
